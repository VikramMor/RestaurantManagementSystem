...
public class VerifyUsers extends javax.swing.JFrame {
      ...
      public void getAllRecords(String email){
            ...
            while (itr.hasNext()) {
                  ...
                  if(!userObj.getEmail().equals("admin@ymail.com")){
                        dtm.addRow(new Object[]{userObj.getId(), userObj.getName(), userObj.getEmail(), userObj.getMobile(), userObj.getAddress(), userObj.getSecurityQuestion(), userObj.getStatus()});
                  }
      ...
      private void initComponents() {
            ...
            getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 70, 72, -1));
            ...
            getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 70, 302, -1));
            ...
            getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 1520, 640));

            jLabel3.setFont(new java.awt.Font("Algerian", 2, 36)); // NOI18N
            jLabel3.setForeground(new java.awt.Color(255, 255, 255));
            jLabel3.setText("*Click on row to change Status");
            getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 780, 620, -1));

            jLabel4.setBackground(new java.awt.Color(0, 153, 153));
            jLabel4.setOpaque(true);
            getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-2, -4, 1930, 1090));
